  ...
  return (
    <div className="min-h-screen bg-paper text-ink">
      ...
      <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-10 lg:py-8">
        <header className="relative z-[100] rounded-[32px] border border-white/70 bg-white/65 px-5 py-4 shadow-panel backdrop-blur dark:border-white/10 dark:bg-white/5 sm:px-6 sm:py-5">
